...
+ (UIViewController * _Nonnull)named:(NSString * _Nonnull)storyboardName vc:(NSString * _Nonnull)vc SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIView (SWIFT_EXTENSION(ZHExtensions))
- (void)addBlurView;
- (void)addOnTopMotionEffectWithRelativeValue:(float)relativeValue;
- (void)addBelowMotionEffectWithRelativeValue:(float)relativeValue;
@end


@interface UIView (SWIFT_EXTENSION(ZHExtensions))
/// Pin four edges to superview
- (void)constraintEdgesTo:(UIView * _Nonnull)to;
- (void)widthConstraintWithWidth:(CGFloat)width;
- (void)heightConstraintWithHeight:(CGFloat)height;
- (void)equalWidthToParentWithParent:(UIView * _Nonnull)parent;
- (void)equalHeightToParentWithParent:(UIView * _Nonnull)parent;
- (void)centerXToParentWithParent:(UIView * _Nonnull)parent;
- (void)centerYToParentWithParent:(UIView * _Nonnull)parent;
- (void)constraintPinToTopWithParent:(UIView * _Nonnull)parent;
