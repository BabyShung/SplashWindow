...
- (BOOL)passcodeEnabled SWIFT_WARN_UNUSED_RESULT;
- (void)setPasscode:(NSString * _Nonnull)passcode;
- (BOOL)touchIDEnabled SWIFT_WARN_UNUSED_RESULT;
- (void)setTouchID:(BOOL)enable;
- (void)removeAllInfo;
@end
